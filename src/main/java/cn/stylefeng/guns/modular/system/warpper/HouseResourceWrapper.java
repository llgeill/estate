 ...
 */
public class HouseResourceWrapper extends BaseControllerWrapper {

    public HouseResourceWrapper(Map<String, Object> single) {
        super(single);
    }

    public HouseResourceWrapper(List<Map<String, Object>> multi) {
        super(multi);
    }

    public HouseResourceWrapper(Page<Map<String, Object>> page) {
        super(page);
    }

    public HouseResourceWrapper(PageResult<Map<String, Object>> pageResult) {
        super(pageResult);
    }
